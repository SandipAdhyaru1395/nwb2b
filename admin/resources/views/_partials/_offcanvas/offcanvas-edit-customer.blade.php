 <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCustomerEdit"
    aria-labelledby="offcanvasCustomerEditLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasCustomerEditLabel" class="offcanvas-title">Edit Customer</h5>
        ...
        <div class="mb-6 pt-4">
          ...
          <div class="mb-6">
            ...
            <input type="text" autocomplete="off" id="business-reg-number" class="form-control" placeholder="Enter business registration number"
              aria-label="Enter business registration number" name="businessRegistrationNumber" value="{{ old('businessRegistrationNumber') ?? $customer->business_reg_number }}"/>
          </div>
          <div class="mb-6">
