        ...
        <form id="editBrandForm" method="POST" action="{{ route('brand.update') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <!-- Media -->
                    <div class="card mb-6">
                        <img class="align-self-center" height="300px" width="400px" src="{{ $brand->image ? asset('storage/'.$brand->image) : asset('public/assets/img/default_brand.png') }}" onerror="this.onerror=null; this.src='{{ asset('public/assets/img/default_brand.png') }}';" />
