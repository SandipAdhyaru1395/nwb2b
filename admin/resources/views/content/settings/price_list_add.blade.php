                ...
                <div class="tab-pane fade show active">
                    ...
                    <div class="card mb-6">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Add Price List</h5>

                            <form action="{{ route('settings.priceList.store') }}" method="POST" id="addPriceListForm">
                                @csrf
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 mb-4 form-control-validation">
                                        ...
                                        <input type="text" onkeypress="return /^[0-9.]+$/.test(event.key)"
                                            ...
                                            name="conversion_rate" value="{{ old('conversion_rate', 100.0) }}"
                                            autocomplete="off">
                                ...
                                <div class="mb-4 form-control-validation">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input @error('price_list_type') is-invalid @enderror"
                                            ...
                                            {{ old('price_list_type', 0) == 0 ? 'checked' : '' }}>
