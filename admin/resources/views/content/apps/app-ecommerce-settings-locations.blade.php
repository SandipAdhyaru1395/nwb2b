    ...
    <div class="tab-content p-0">
      ...
      <div class="tab-pane fade show active" id="locations" role="tabpanel">
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            <div class="alert row alert-info mb-0 h5 mx-0" role="alert">
              ...
              <div class="col text-wrap ps-4 pe-0">This is your default location. To change whether you fulfill online
        ...
        <div class="d-flex justify-content-end gap-4">
          ...
          <a class="btn btn-primary" href="{{ url('/settings/notifications') }}">Save Changes</a>
        </div>
      </div>
    </div>
    <!-- /Options-->
