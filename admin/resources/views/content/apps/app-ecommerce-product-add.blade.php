...
<div class="app-ecommerce">
  <!-- Add Product -->
  <form method="POST" action="{{ route('app-ecommerce-product-store') }}">
    @csrf
    @if ($errors->any())
  ...
  <div
    ...
    <div class="d-flex align-content-center flex-wrap gap-4">
      <div class="d-flex gap-4"><button type="button" class="btn btn-label-secondary">Discard</button> <button
          type="button" class="btn btn-label-primary">Save draft</button></div>
        ...
        <div class="card-body">
          <div class="mb-6">
            ...
            <input type="text" class="form-control" id="ecommerce-product-name" placeholder="Product title"
              name="productTitle" aria-label="Product title" value="{{ old('productTitle') }}" />
          </div>
          <div class="row mb-6">
            <div class="col"><label class="form-label" for="ecommerce-product-sku">SKU</label> <input type="number"
                ...
                aria-label="Product SKU" value="{{ old('productSku') }}" /></div>
            <div class="col"><label class="form-label" for="ecommerce-product-barcode">Barcode</label> <input
                ...
                name="productBarcode" aria-label="Product barcode" value="{{ old('productBarcode') }}" /></div>
          </div>
          <!-- Description -->
          <div>
                  ...
                  <div class="row mb-4 g-4 pe-md-4">
                    <div class="col-12 col-sm-9">
                      <input type="number" class="form-control" id="ecommerce-product-stock" placeholder="Quantity"
                        name="quantity" aria-label="Quantity" value="{{ old('quantity') }}" />
                    </div>
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          ...
          <div class="mb-6">
            ...
            <input type="number" step="0.01" class="form-control" id="ecommerce-product-price" placeholder="Price"
              name="productPrice" aria-label="Product price" value="{{ old('productPrice') }}" />
          </div>
          <!-- Discounted Price -->
          <div class="mb-6">
            <label class="form-label" for="ecommerce-product-discount-price">Discounted Price</label>
            <input type="number" step="0.01" class="form-control" id="ecommerce-product-discount-price"
              placeholder="Discounted Price" name="productDiscountedPrice" aria-label="Product discounted price" value="{{ old('productDiscountedPrice') }}" />
          </div>
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          ...
          <div class="mb-6 col ecommerce-select2-dropdown">
            ...
            <select id="vendor" name="vendor" class="select2 form-select" data-placeholder="Select Vendor">
              <option value="">Select Vendor</option>
              <option value="men-clothing" @selected(old('vendor')==='men-clothing')>Men's Clothing</option>
              <option value="women-clothing" @selected(old('vendor')==='women-clothing')>Women's-clothing</option>
              <option value="kid-clothing" @selected(old('vendor')==='kid-clothing')>Kid's-clothing</option>
            </select>
          </div>
          <!-- Category -->
          <div class="d-flex justify-content-between align-items-center">
            <div class="mb-6 col ecommerce-select2-dropdown">
              ...
              <select id="category-org" name="category" class="select2 form-select" data-placeholder="Select Category">
                ...
                <option value="Household" @selected(old('category')==='Household')>Household</option>
          ...
          <div class="mb-6 col ecommerce-select2-dropdown">
            ...
            <select id="status-org" name="status" class="select2 form-select" data-placeholder="Publish">
