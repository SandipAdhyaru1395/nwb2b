...
@section('page-script')
  @vite(['resources/assets/js/app-access-roles.js', 'resources/assets/js/modal-edit-role.js', 'resources/assets/js/modal-add-role.js'])
  <script>
                ...
                @if($role->users()->count() > 4)
                  <li class="avatar">
                    <span class="avatar-initial rounded-circle pull-up" data-bs-toggle="tooltip" data-bs-placement="bottom"
                      title="2 more">+{{ $role->users()->count() - 4 }}</span>
                  </li>
                @endif
              </ul>
            </div>
