      ...
      <div class="card-body">
        ...
        <div class="mb-4">
          <div class="d-flex w-100 action-icons">
            <input id="defaultInput" class="form-control me-4 phone-number-mask" type="text"
              placeholder="+1(968) 945-8832" />
            <a href="javascript:;" class="btn btn-icon btn-text-secondary rounded-pill" data-bs-target="#enableOTP"
              data-bs-toggle="modal"><i class="icon-base ti tabler-edit icon-md text-heading"></i></a>
            <a href="javascript:;" class="btn btn-icon btn-text-secondary rounded-pill"><i
                class="icon-base ti tabler-user-plus icon-md text-heading"></i></a>
          </div>
        </div>
        <p class="mb-0">
