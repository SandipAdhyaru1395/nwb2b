...
@section('page-script')
    @vite(['resources/assets/js/app-ecommerce-collection-edit.js'])
@endsection

@section('content')
    <div class="app-ecommerce">
        <!-- Add Collection -->
        <form id="editCollectionForm" method="POST" action="{{ route('collection.update') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{ $collection->id }}">
            <div
                class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1">Edit Collection</h4>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="mb-6 form-control-validation">
                                ...
                                <input type="text" class="form-control" id="collection-name"
                                    ...
                                    value="{{ $collection->name }}" autocomplete="off" />
                    ...
                    <!-- Media -->
                    <div class="card mb-6">
                        <img class="align-self-center" height="300px" width="400px" src="{{  asset('storage/'.$collection->image) }}" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="form-check mb-6 col ecommerce-select2-dropdown form-control-validation">
                                    <input type="checkbox" class="form-check-input" name="isNew" id="isNew" @checked($collection->is_new == 1)>
                                    <label class="form-check-label mb-5" for="isNew">
                                        New
                                    </label>
                                </div>
                                <div class="form-check mb-6 col ecommerce-select2-dropdown form-control-validation">    
                                    <input type="checkbox" class="form-check-input" name="isSale" id="isSale" @checked($collection->is_sale == 1)>
                                    <label class="form-check-label mb-5" for="isSale">
                                        Sale
                                    </label>
                                </div>
                                <div class="form-check mb-6 col ecommerce-select2-dropdown form-control-validation">    
                                    <input type="checkbox" class="form-check-input" name="isHot" id="isHot" @checked($collection->is_hot == 1)>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mb-6 col ecommerce-select2-dropdown form-control-validation">
                                    ...
                                    <select class="form-select select2" name="collectionStatus" id="collectionStatus">
                                        <option value="1" @selected($collection->is_active == '1')>Active</option> 
                                        <option value="0" @selected($collection->is_active == '0')>Inactive</option>
                                    </select>                                   
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mb-6 col ecommerce-select2-dropdown form-control-validation">
                                    ...
                                    <select class="form-select select2" name="brand_id" id="brand_id">
                                        ...
                                        @forelse($brands as $brand)
                                            <option value="{{$brand->id}}" @selected($collection->brand_id == $brand->id)>{{$brand->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                    @error('brand_id')
                            ...
                            <div>
                                ...
                                <input id="collection-tags" class="form-control" name="collectionTags"
                                    aria-label="Collection Tags" value="{{ $collectionTags }}" />
                            </div>
                        </div>
                    </div>
                    <!-- /Organize Card -->
