...
@section('content')
<!-- Header -->
@include('content.pages.user-profile-header')
<!--/ Header -->
  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url('profile-teams') }}"><i class="icon-base ti tabler-users icon-sm me-1_5"></i> Teams</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('profile-projects') }}"><i class="icon-base ti tabler-layout-grid icon-sm me-1_5"></i> Projects</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('profile-connections') }}"><i class="icon-base ti tabler-link icon-sm me-1_5"></i> Connections</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="card mb-6">
      <div class="card-body">
        ...
        <ul class="list-unstyled my-3 py-1">
          <li class="d-flex align-items-center mb-4"><i class="icon-base ti tabler-user icon-lg"></i><span class="fw-medium mx-2">Name:</span> <span>{{ auth()->user()->name }}</span></li>
          <li class="d-flex align-items-center mb-4"><i class="icon-base ti tabler-check icon-lg"></i><span class="fw-medium mx-2">Status:</span> <span>{{ auth()->user()->status }}</span></li>
          @if(auth()->user()->role)
            @php
              $icon = [
            ...
            @endphp
            <li class="d-flex align-items-center mb-4"><i class="icon-base ti {{ $icon[auth()->user()->role->name] ?? '' }} icon-lg"></i><span class="fw-medium mx-2">Role:</span> <span> {{  auth()->user()->role->name }}</span></li>
          @endif
        </ul>
