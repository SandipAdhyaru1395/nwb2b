                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col form-control-validation">
                                    <label class="form-label" for="ecommerce-product-unit-sku">Product Unit Code <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="ecommerce-product-unit-sku" placeholder="Product Unit Code"
                                        name="productUnitSku" aria-label="Product Unit Code" value="{{ old('productUnitSku') }}"
                                        autocomplete="off" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-5 form-control-validation">
                                    ...
                                    <input type="text" onkeypress="return /^[0-9.]+$/.test(event.key)"
                                        ...
                                        aria-label="Wallet Credit" value="{{ old('walletCredit') }}" autocomplete="off" />
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-5 form-control-validation">
                                    ...
                                    <input type="text" onkeypress="return /^[0-9.]+$/.test(event.key)" class="form-control" id="weight" placeholder="Weight" name="weight" value="{{ old('weight') }}" autocomplete="off" />
                                    @error('weight')
                                ...
                                <div class="col-lg-4 mb-5 form-control-validation">
                                    ...
                                    <input type="text" onkeypress="return /^[0-9.]+$/.test(event.key)" class="form-control" id="rrp" placeholder="RRP" name="rrp" value="{{ old('rrp') }}" autocomplete="off" />
                                    @error('rrp')
                                        <span class="text-danger" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-lg-4 mb-5 form-control-validation">
                                    ...
                                    <input type="text" class="form-control flatpickr" id="expiry_date" name="expiry_date" placeholder="dd/mm/yyyy" value="{{ old('expiry_date') }}" readonly/>
                                    @error('expiry_date')
                                        <span class="text-danger" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-5 form-control-validation"><label class="form-label"
                                ...
                                <div class="col-md-4 col-8 mx-auto mb-5 form-control-validation"><label class="form-label"
                                    ...
                                    <div class="position-relative d-flex gap-2 align-items-center w-75">
                                        <button style="width:25px; left:10;"
                                            class="left-0 position-absolute btn btn-sm btn-danger h-75" type="button"
                                            id="stepMinus">
                                            <i class="flex-shrink-0 ti tabler-minus"></i>
                                        </button>
                                        <input type="text" name="step" id="step"
                                            onkeypress="return /^[0-9]+$/.test(event.key)"
                                            class="form-control text-center" value="1" autocomplete="off">
