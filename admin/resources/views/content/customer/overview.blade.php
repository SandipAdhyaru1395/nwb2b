...
'resources/assets/js/offcanvas-edit-customer.js'])
<script>
  @if ($errors->edit->any())
          ...
          <div class="card-body">
            ...
            <div class="card-info">
              ...
              <div class="d-flex align-items-baseline gap-1">
                <h5 class="text-primary mb-0">{{ $currencySymbol }}{{ number_format($customer->credit_balance ?? 0, 2) }}</h5>
...
@include('_partials/_offcanvas/offcanvas-edit-customer')
@endsection
