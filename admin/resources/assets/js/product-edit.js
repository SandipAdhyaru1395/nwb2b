...
<div class="dz-details">
  ...
  // Store original image URL if exists (for validation purposes)
  let hasOriginalImage = false;
  if (editProductForm) {
    const existingImageContainer = document.getElementById('existingImageContainer');
    hasOriginalImage = existingImageContainer !== null;
  }
      ...
      fields: {
            ...
            remote: {
              ...
              data: function() {
                return {
                  ...
                  sku: editProductForm.querySelector('[name="productSku"]').value,
                  id: editProductForm.querySelector('[name="id"]').value
                };
              },
              delay: 500
            }
          ...
          validators: {
            ...
            remote: {
              ...
              data: function() {
                return {
                  _token: document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                  sku: editProductForm.querySelector('[name="productUnitSku"]').value,
                  id: editProductForm.querySelector('[name="id"]').value
                };
              },
              delay: 500
        ...
        productImageUrl: {
          validators: {
            ...
            callback: {
              message: 'Either an image file or image URL is required (if no existing image).',
              callback: function(value, validator, $field) {
                ...
                // If there's an existing image, no need for new image
                if (hasOriginalImage) {
                  return true;
                }
